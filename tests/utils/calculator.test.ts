...
Deno.test("sumItems", async (t) => {
  await t.step("calulates sum of income and expense", () => {
    const items = [
      { title: "item1", amount: 100, date: "2023-05-04", user: "user1" },
      { title: "item2", amount: 100, date: "2023-05-04", user: "user1" },
      { title: "item3", amount: -100, date: "2023-05-04", user: "user1" },
      { title: "item4", amount: -100, date: "2023-05-04", user: "user1" },
    ];
...
Deno.test("calculateGrade", async (t) => {
  await t.step("returns A when ratio is less than 10", () => {
    const items = [
      { title: "item1", amount: 1000, date: "2023-05-04", user: "user1" },
      { title: "item2", amount: -99, date: "2023-05-04", user: "user1" },
    ];
  ...
  await t.step(
    ...
    () => {
      const items = [
        { title: "item1", amount: 1000, date: "2023-05-04", user: "user1" },
        { title: "item2", amount: -500, date: "2023-05-04", user: "user1" },
      ];
      const grade = calculateGrade(items);
  ...
  await t.step("returns D when ratio is greater than 50", () => {
    const items = [
      { title: "item1", amount: 1000, date: "2023-05-04", user: "user1" },
      { title: "item2", amount: -501, date: "2023-05-04", user: "user1" },
    ];
    const grade = calculateGrade(items);
